			...
			<div class="col-lg-6">
				...
				<div class="product-thumbs" tabindex="1" style="overflow: hidden; outline: none;">
					<div class="product-thumbs-track">
						<div class="pt active" data-imgbigurl="resources/img/product/{{$sanpham->hinh}}"><img class="thumbsmall" src="resources/img/product/{{$sanpham->hinh}}" alt=""></div>

						@if(!empty($sanpham->h1))	
						<div class="pt" data-imgbigurl="resources/img/product/{{$sanpham->ten_file}}/{{$sanpham->h1}}"><img class="thumbsmall" src="resources/img/product/{{$sanpham->ten_file}}/{{$sanpham->h1}}"alt=""></div>
						@endif
						@if(!empty($sanpham->h2))	
						<div class="pt" data-imgbigurl="resources/img/product/{{$sanpham->ten_file}}/{{$sanpham->h2}}"><img class="thumbsmall" src="resources/img/product/{{$sanpham->ten_file}}/{{$sanpham->h2}}"alt=""></div>
						@endif
						@if(!empty($sanpham->h3))	
						<div class="pt" data-imgbigurl="resources/img/product/{{$sanpham->ten_file}}/{{$sanpham->h3}}"><img class="thumbsmall" src="resources/img/product/{{$sanpham->ten_file}}/{{$sanpham->h3}}"alt=""></div>
						@endif
						@if(!empty($sanpham->h4))	
						<div class="pt" data-imgbigurl="resources/img/product/{{$sanpham->ten_file}}/{{$sanpham->h4}}"><img class="thumbsmall" src="resources/img/product/{{$sanpham->ten_file}}/{{$sanpham->h4}}"alt=""></div>
						@endif
			...
			<div class="col-lg-6 product-details">
					...
					<tbody>
						...
						<tr>
							...
							<td> 	@foreach($chitietsp as $detail)
								...
								{{$detail->size_sp->ten_size}}  ({{$detail->tu}} kg-{{$detail->den}} kg)<br>
								@endif
								@endforeach
				...
				<div id="accordion" class="accordion-area">
					<div class="panel">
						...
						<div class="su-box su-box-style-default" id="" style="border-color:#ae0000;border-radius:0px"><div class="su-box-title" style="background-color:#e11b1e;color:#ffffff;border-top-left-radius:0px;border-top-right-radius:0px">LƯU Ý KHI MUA SALE</div><div class="su-box-content su-u-clearfix su-u-trim" style="border-bottom-left-radius:0px;border-bottom-right-radius:0px">
							❌ Hàng SALE <b style="color:#e11b1e">KHÔNG ĐỔI TRẢ</b> dưới mọi hình thức<br>
							❌ Vui lòng kiểm tra kĩ size/màu sản phẩm trước khi chốt đơn.<br>
							❌ Shop sẽ giao đủ màu ngẫu nhiên đối với các sản phẩm Quần nhiều màu (không chọn màu)
						</div></div>
						<div class="su-box su-box-style-default" id="" style="border-color:#54996f;border-radius:0px"><div class="su-box-title" style="background-color:#87cca2;color:#ffffff;border-top-left-radius:0px;border-top-right-radius:0px">LƯU Ý KHI MUA HÀNG</div><div class="su-box-content su-u-clearfix su-u-trim" style="border-bottom-left-radius:0px;border-bottom-right-radius:0px">
							<div class="su-list" style="margin-left:0px">
								<ul>
									<li><i class="sui sui-check" style="color:#333"></i> Màu/size nào không chọn được tức đã bị hết, quý khách vui lòng chọn màu khác/size khác
									</li>
								</ul>
							</div>
						</div></div>
