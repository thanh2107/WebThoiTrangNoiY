    ...
    <ul class="nav pull-right top-menu">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu extended logout">
                ...
                <li><a href="{{route('admin_logout')}}"><i class="fa fa-key"></i>Đăng xuất</a></li>
            </ul>
        </li>
        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                <li class="sub-menu">
                    ...
                    <ul class="sub">
						<li><a href="{{route('add_category')}}">Thêm danh mục sản phẩm</a></li>
						<li><a href="{{route('all_category')}}">Liệt kê danh mục sản phẩm</a></li>
                    </ul>
                </li>
                <li>
